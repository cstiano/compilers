...
class CymbolVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by CymbolParser#FormTypeBoolean.
    ...
    # Visit a parse tree produced by CymbolParser#ifStatmentCall.
    def visitIfStatmentCall(self, ctx:CymbolParser.IfStatmentCallContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by CymbolParser#OrAndExpr.
